    ...
    return (
        <div className='h-screen w-full overflow-hidden relative' style={{
            ...
            <div className='border-4 border-gray-200 rounded-3xl px-7 py-10 h-fit w-[356px] mx-8  bg-[#F7F7F7] absolute top-1/4 z-20'>
                ...
                <h1 className='font-bold text-2xl'>Include your Equipment:</h1>
                <div className='my-5'>
                    <textarea className="form-textarea rounded-2xl p-2 mt-1 block w-full" rows="8" placeholder="Lights, Lenses, Microphones, etc."></textarea>
                </div>
